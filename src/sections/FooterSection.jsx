...
const FooterSection = () => {
  ...
  return (
    <section className="footer-section">
      ...
      <div className="min-h-screen relative md:pt-[20vh] pt-[10vh] flex flex-col justify-between">
        ...
        <div className="mt-20 mb-10 md:px-10 px-5 flex gap-10 md:flex-row flex-col justify-between text-milk font-paragraph md:text-lg font-medium">
